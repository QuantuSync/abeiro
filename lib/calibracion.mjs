...
// Correlación de Spearman (rangos con empates promediados) entre dos arrays.
// Devuelve null si algún array es constante (correlación indefinida).
export function spearman(a, b) {
  const rangos = (v) => {
    const orden = v.map((x, i) => [x, i]).sort((p, q) => p[0] - q[0]);
